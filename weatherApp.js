   //geolocation on button press
    ...
    function lookupCoord(lon, lat) {
        ...
        var url = "http://api.openweathermap.org/data/2.5/forecast?lat=" + lat + "&lon=" + lon + "&units=" + degree + "&APPID=88a229a981d7c6eed6e27b9867e4a139";
    ...
    function getWeatherData(city, country, unit) {
        ...
        var url = "http://api.openweathermap.org/data/2.5/forecast?q=" + city + "," + country + "&units=" + unit + "&APPID=88a229a981d7c6eed6e27b9867e4a139";
        //alert(url);
